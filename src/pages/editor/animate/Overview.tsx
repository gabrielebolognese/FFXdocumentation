...
const tableOfContents = [
  ...
  { id: 'the-keyframe-system', label: 'The Keyframe System' },
...
export default function AnimateOverview() {
  return (
    <Layout tableOfContents={tableOfContents}>
      <SEO
        title="Entering Animate Mode & The Keyframe System | FlashFX Documentation"
        description="Learn how to enter Animate Mode, use Record Mode, and work with the keyframe system in FlashFX."
        keywords="FlashFX, animate mode, keyframes, record mode, playhead, timeline"
      />
      ...
      <div className="max-w-4xl space-y-8">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-white/80">
          ...
          <Section id="switching-to-animate-mode" title="Switching to Animate Mode">
            <p>Click the <strong className="text-white">Animate</strong> button in the mode switcher at the top of the interface, or press <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Ctrl+2</code>.</p>
            <p>The interface rearranges:</p>
          ...
          <Section id="record-mode-toggle" title="Record Mode Toggle">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span>Press <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Ctrl+Alt+R</code></li>
            </ul>
          ...
          <Section id="the-playhead" title="The Playhead">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span><strong className="text-white">Position:</strong> Shown in the timecode display as <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">HH:MM:SS:FF</code> (hours, minutes, seconds, frames)</li>
          ...
          <Section id="the-keyframe-system" title="The Keyframe System">
          ...
          <Section id="creating-keyframes" title="Creating Keyframes">
            ...
            <p><strong className="text-white">Manual:</strong> Press <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">K</code> with an element selected to create a keyframe on all currently animated properties at the current playhead time. This inserts a hold keyframe at the current value without changing the property.</p>
          ...
          <Section id="selecting-keyframes" title="Selecting Keyframes">
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span><code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Shift+click</code> to add to selection</li>
              ...
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span><code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Ctrl+A</code> in the timeline to select all keyframes on all tracks for all elements</li>
            </ul>
          </Section>
          ...
          <Section id="copying-and-pasting-keyframes" title="Copying and Pasting Keyframes">
            <ul className="space-y-2 text-sm">
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span>Copy: <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Ctrl+C</code> on selected keyframes</li>
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span>Paste: <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Ctrl+V</code>,pastes at the current playhead position</li>
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span>Paste in Place: <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Ctrl+Shift+V</code>,pastes at the same time positions as the source</li>
            </ul>
          ...
          <Section id="deleting-keyframes" title="Deleting Keyframes">
            <ul className="space-y-2 text-sm">
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">•</span>Select and press <code className="text-yellow-accent bg-white/5 px-1.5 py-0.5 rounded">Delete</code></li>
