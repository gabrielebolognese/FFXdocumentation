...
export default function CharacterFormatting() {
  return (
    <Layout>
      <SEO
        title="Character-Level Formatting | FlashFX Documentation"
        description="Complete reference for character-level text formatting in FlashFX."
        keywords="FlashFX, character formatting, font weight, kerning, tracking, baseline shift"
      />
      <div className="max-w-4xl space-y-8">
        <div>
          <span className="inline-block text-yellow-accent text-[10px] font-medium mb-2 uppercase tracking-wider">Text</span>
          <h1 className="text-4xl font-bold text-white mb-6">Character-Level Formatting</h1>
        </div>
        <div className="prose prose-invert max-w-none space-y-8 text-white/80">
          ...
          <Section title="Underline and Strikethrough">
          ...
          <Section title="Superscript and Subscript">
          ...
          <Section title="All Caps and Small Caps">
          ...
          <Section title="Character Spacing (Tracking)">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li className="flex gap-3"><span className="text-yellow-accent mt-1">-</span>0 = the font's default spacing</li>
            </ul>
          </Section>
          <Section title="Kerning">
            ...
            <p><strong className="text-white">Auto Kerning:</strong> FlashFX applies the font's built-in kerning pairs automatically.</p>
            ...
            <p><strong className="text-white">Manual Kerning:</strong> Place the cursor between two characters and adjust the kerning value in the Properties Panel to apply a custom correction.</p>
          </Section>
          <Section title="Baseline Shift">
            ...
            <p>Useful for: custom superscript and subscript refinement, mixed-size type alignment, and creative typographic treatments.</p>
          </Section>
          <Section title="Horizontal Scale and Vertical Scale">
