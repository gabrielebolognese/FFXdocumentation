      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { label: '27. Text box modes', path: '/beginner-to-hero/27-text-box-modes' },
            { label: '28. Character formatting', path: '/beginner-to-hero/28-character-formatting' },
            { label: '29. Paragraph formatting', path: '/beginner-to-hero/29-paragraph-formatting' },
            { label: '30. Styling text', path: '/beginner-to-hero/30-styling-text' },
            { label: '31. Text on a path', path: '/beginner-to-hero/31-text-on-a-path' },
          ],
        },
        {
          label: '6. Images',
          children: [
            { label: '32. Importing images', path: '/beginner-to-hero/32-importing-images' },
            { label: '33. Transform and placement', path: '/beginner-to-hero/33-image-transform-and-placement' },
            { label: '34. Cropping and masking', path: '/beginner-to-hero/34-cropping-and-masking' },
            { label: '35. Images as a shape fill', path: '/beginner-to-hero/35-image-fill-mode' },
            { label: '36. Color adjustment', path: '/beginner-to-hero/36-color-adjustment' },
            { label: '37. Blur and stylization', path: '/beginner-to-hero/37-blur-and-stylization' },
            { label: '38. Distortion and atmosphere', path: '/beginner-to-hero/38-distortion-and-atmosphere' },
          ],
        },
        {
          label: '7. Animation fundamentals',
          children: [
            { label: '39. Entering Animate mode', path: '/beginner-to-hero/39-entering-animate-mode' },
            { label: '40. Your first keyframes', path: '/beginner-to-hero/40-your-first-keyframes' },
            { label: '41. Keyframe types', path: '/beginner-to-hero/41-keyframe-types' },
            { label: '42. Property tracks', path: '/beginner-to-hero/42-property-tracks' },
            { label: '43. Easing', path: '/beginner-to-hero/43-easing' },
            { label: '44. The easing graph editor', path: '/beginner-to-hero/44-the-easing-graph' },
            { label: '45. Animating transforms', path: '/beginner-to-hero/45-animating-transforms' },
            { label: '46. Animating color', path: '/beginner-to-hero/46-animating-color' },
            { label: '47. Animating effects', path: '/beginner-to-hero/47-animating-effects' },
          ],
        },
        {
          label: '8. Advanced motion',
          children: [
            { label: '48. Motion paths', path: '/beginner-to-hero/48-motion-paths' },
            { label: '49. Spatial interpolation', path: '/beginner-to-hero/49-spatial-interpolation' },
            { label: '50. Text animation modes', path: '/beginner-to-hero/50-text-animation-modes' },
            { label: '51. Stagger and per-unit animation', path: '/beginner-to-hero/51-stagger-animation' },
            { label: '52. Morph and deform', path: '/beginner-to-hero/52-morph-and-vertex-animation' },
            { label: '53. Parenting and nulls', path: '/beginner-to-hero/53-parenting-and-nulls' },
            { label: '54. Expressions and value linking', path: '/beginner-to-hero/54-expressions' },
            { label: '55. Looping and cycles', path: '/beginner-to-hero/55-looping-and-cycles' },
          ],
        },
        {
          label: '9. The timeline',
          children: [
            { label: '56. Timeline architecture', path: '/beginner-to-hero/56-timeline-architecture' },
            { label: '57. Track organization', path: '/beginner-to-hero/57-track-organization' },
            { label: '58. Advanced keyframe operations', path: '/beginner-to-hero/58-advanced-keyframe-operations' },
            { label: '59. The graph editor in depth', path: '/beginner-to-hero/59-the-graph-editor' },
            { label: '60. The work area', path: '/beginner-to-hero/60-the-work-area' },
            { label: '61. Time remapping', path: '/beginner-to-hero/61-time-remapping' },
            { label: '62. Layer duration and trim', path: '/beginner-to-hero/62-layer-duration-and-trim' },
            { label: '63. Markers and beat syncing', path: '/beginner-to-hero/63-markers-and-sync' },
            { label: '64. Search and filtering', path: '/beginner-to-hero/64-timeline-search' },
          ],
        },
        {
          label: '10. Composition at scale',
          children: [
            { label: '65. The sequence compositor', path: '/beginner-to-hero/65-the-sequence-compositor' },
            { label: '66. Clips and transitions', path: '/beginner-to-hero/66-clip-operations-and-transitions' },
            { label: '67. Nested sequences', path: '/beginner-to-hero/67-nested-sequences' },
            { label: '68. Adjustment layers and control rigs', path: '/beginner-to-hero/68-adjustment-layers-and-rigs' },
          ],
        },
        {
          label: '11. 3D, performance and output',
          children: [
            { label: '69. 3D transforms', path: '/beginner-to-hero/69-3d-transforms' },
            { label: '70. Camera and lighting', path: '/beginner-to-hero/70-camera-and-lighting' },
            { label: '71. The rendering environment', path: '/beginner-to-hero/71-the-rendering-environment' },
            { label: '72. Profiling and optimisation', path: '/beginner-to-hero/72-profiling-and-optimisation' },
            { label: '73. Preview and export', path: '/beginner-to-hero/73-preview-and-export' },
          ],
        },
      ],
    },
...
export const flashccSidebar: SidebarConfig = {
  sections: [
    ...
    },
    {
      ...
      collapsible: true,
      items: [
        { label: '1. What it is', path: '/flashcc/what-it-is' },
        { label: '2. Running it', path: '/flashcc/running-it' },
        { label: '3. The invariants', path: '/flashcc/the-invariants' },
      ],
    },
    {
      label: 'The canvas',
      ...
      collapsible: true,
      items: [
        { label: '4. The data model', path: '/flashcc/the-data-model' },
        { label: '5. The canvas', path: '/flashcc/the-canvas' },
        { label: '6. Text measurement and fitting', path: '/flashcc/text-measurement-and-fitting' },
        { label: '7. Colour and contrast', path: '/flashcc/colour-and-contrast' },
        { label: '8. Gradients', path: '/flashcc/gradients' },
        { label: '9. Changing format (reflow)', path: '/flashcc/changing-format' },
      ],
    },
    {
      label: 'Making a deck',
      ...
      collapsible: true,
      items: [
        { label: '10. The four frameworks', path: '/flashcc/the-four-frameworks' },
        { label: '11. Generation', path: '/flashcc/generation' },
        { label: '12. Styles and themes', path: '/flashcc/styles-and-themes' },
        { label: '13. Onboarding', path: '/flashcc/onboarding' },
        { label: '14. AI drafting', path: '/flashcc/ai-drafting' },
        { label: '15. Bulk create', path: '/flashcc/bulk-create' },
        { label: '16. Media and fonts', path: '/flashcc/media-and-fonts' },
        { label: '17. Screen flow', path: '/flashcc/screen-flow' },
      ],
    },
    {
      label: 'The product',
      ...
      collapsible: true,
      items: [
        { label: '18. The pipeline', path: '/flashcc/the-pipeline' },
        { label: '19. Analytics', path: '/flashcc/analytics' },
        { label: '20. The library', path: '/flashcc/the-library' },
        { label: '21. Export', path: '/flashcc/export' },
      ],
    },
    {
      ...
      collapsible: true,
      items: [
        { label: '22. Persistence', path: '/flashcc/persistence' },
        { label: '23. Sync', path: '/flashcc/sync' },
        { label: '24. Auth', path: '/flashcc/auth' },
        { label: '25. Billing', path: '/flashcc/billing' },
        { label: '26. Database', path: '/flashcc/database' },
        { label: '27. Design tokens', path: '/flashcc/design-tokens' },
        { label: '28. Testing', path: '/flashcc/testing' },
      ],
    },
    {
      label: 'Reality check',
      ...
      collapsible: true,
      items: [
        { label: '29. Known defects', path: '/flashcc/known-defects' },
      ],
    },
  ],
};
